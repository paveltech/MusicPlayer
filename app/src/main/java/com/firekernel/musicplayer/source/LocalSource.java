 ...
 * Local Source, list list browsable and playable items in local system
 */
...
public class LocalSource implements MusicProviderSource {
    ...
    private void getUri(){
        MediaMetadataCompat mediaMetadataCompat = new MediaMetadataCompat.Builder()
                .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI, " http://www.songs.com/song1.mp3").build();
    }
